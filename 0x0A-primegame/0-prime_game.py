...
def isWinner(x, nums):
    ...
    # Get all primes up to the maximum number in nums
    primes = sieve(max_n)
    
    # Memoization for determining the winner for each n
    winner_cache = {}

    def determine_winner(n):
        """ Determine the winner for a game with numbers 1 to n """
        ...
        while True:
            # Find the next prime in the set
            prime_found = False
            for prime in primes:
